...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { Date: @pizza.Date, Ingredients: @pizza.Ingredients, Storage: @pizza.Storage, Suppliers: @pizza.Suppliers } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { Date: @pizza.Date, Ingredients: @pizza.Ingredients, Storage: @pizza.Storage, Suppliers: @pizza.Suppliers } }
